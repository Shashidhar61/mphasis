...
select	account_number,customer_master.customer_number,firstname,lastname,account_opening_date from customer_master 
join account_master on customer_master.customer_number=account_master.customer_number order by account_number;
